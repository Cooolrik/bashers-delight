...
class Device : public InstanceSubmodule
	...
	public:
		...
		VkPhysicalDevice GetPhysicalDeviceHandle() const
			{
			return this->PhysicalDeviceHandle;
			}
		VkQueue GetGraphicsQueueHandle() const
			{
			return this->GraphicsQueueHandle;
			}
		VkQueue GetPresentQueueHandle() const
			{
			return this->PresentQueueHandle;
			}
		uint GetPhysicalDeviceQueueGraphicsFamily() const
			{
			return this->PhysicalDeviceQueueGraphicsFamily;
			}
		uint GetPhysicalDeviceQueuePresentFamily() const
			{
			return this->PhysicalDeviceQueuePresentFamily;
			}
		VkPhysicalDeviceFeatures2 GetPhysicalDeviceFeatures() const
			{
		...
		vector<const char *> GetDeviceExtensionList() const
			{
			return this->DeviceExtensionList;
			}
		...
		vector<VkSurfaceFormatKHR> GetAvailableSurfaceFormats() const
			{
			return this->AvailableSurfaceFormats;
			}
		vector<VkPresentModeKHR> GetAvailablePresentModes() const
			{
			return this->AvailablePresentModes;
			}
		...
		VmaAllocator GetMemoryAllocatorHandle() const
			{
			return this->MemoryAllocatorHandle;
			}
