...
//
//
//VkCommandBuffer bdr::Instance::BeginInternalCommandBuffer() const
//	{
...
//	}
//
//void bdr::Instance::EndAndSubmitInternalCommandBuffer( VkCommandBuffer buffer ) const
//	{
...
//	}
//
//VkBuffer bdr::Instance::CreateVulkanBuffer( VkBufferUsageFlags bufferUsageFlags, VmaMemoryUsage memoryPropertyFlags, VkDeviceSize deviceSize, VmaAllocation& deviceMemory ) const
//	{
//	VkBuffer buffer;
//
...
//		{
//		throw runtime_error( "Instance device not setup" );
//		}
//
...
//	}
//
//void bdr::Instance::CreateSwapChainAndFramebuffers( const CreateSwapChainParameters& parameters )
//	{
//	if( this->Device == nullptr )
//		{
//		throw runtime_error( "Instance device not setup" );
...
//	}
//
//void bdr::Instance::RecreateSwapChain( const CreateSwapChainParameters& parameters )
//	{
//	if( this->SwapChain == nullptr )
//		{
...
//	}
//
//void bdr::Instance::DeleteSwapChain()
//	{
...
//	}
//
//bdr::CommandPool* bdr::Instance::CreateCommandPool( uint bufferCount ) const
//	{
...
//	}
//
//bdr::Pipeline* bdr::Instance::CreateGraphicsPipeline( const GraphicsPipelineTemplate& gpt ) const
//	{
...
//	}
//
//bdr::Pipeline* bdr::Instance::CreateComputePipeline( const ComputePipelineTemplate& cpt ) const
//	{
//	Pipeline* pipeline = new Pipeline( this );
...
//	}
//
//VkResult bdr::Instance::AcquireNextFrame( uint& index )
//	{
...
//	}
//
//VkResult bdr::Instance::SubmitRenderCommandBuffersAndPresent( const std::vector<VkCommandBuffer>& buffers )
//	{
//	// set frame as busy
...
//	}
//
//bdr::Buffer* bdr::Instance::CreateBuffer( const BufferTemplate& bt ) const
//	{
//	return NewBuffer<Buffer, BufferTemplate>( bt );
//	}
//
//bdr::VertexBuffer* bdr::Instance::CreateVertexBuffer( const VertexBufferTemplate& bt ) const
//	{
...
//	}
//
//bdr::IndexBuffer* bdr::Instance::CreateIndexBuffer( const IndexBufferTemplate& bt ) const
//	{
...
//	}
//
//bdr::DescriptorSetLayout* bdr::Instance::CreateDescriptorSetLayout( const DescriptorSetLayoutTemplate& dst ) const
//	{
...
//	}
//
//void bdr::Instance::WaitForDeviceIdle()
//	{
//	if( this->Device == nullptr )
//		{
...
//	}
//
//bdr::DescriptorPool* bdr::Instance::CreateDescriptorPool( const DescriptorPoolTemplate& dpt ) const
//	{
...
//	}
//
//void bdr::Instance::RunBlockingCommandBuffer( std::function<void( VkCommandBuffer cmd )> fp ) const
//	{
