...
class Instance
	...
	public:
		...
		vector<Extension *> GetEnabledExtensions() const
			{
			return this->EnabledExtensions;
			}
		DescriptorIndexingExtension *GetDescriptorIndexingExtension() const
			{
			return this->DescriptorIndexingExtension_.get();
			}
		BufferDeviceAddressExtension *GetBufferDeviceAddressExtension() const
			{
			return this->BufferDeviceAddressExtension_.get();
			}
		RayTracingExtension *GetRayTracingExtension() const
			{
			return this->RayTracingExtension_.get();
			}
